...
if [ ! -e wp-config.php ]; then
    ...
    sudo -u www-data sh -c "wp config create --dbname=$WORDPRESS_DB_NAME --dbuser=$WORDPRESS_DB_USER --dbpass=$WORPRESS_DB_PASSWORD --dbhost=$WORDPRESS_DB_HOST --dbcharset='utf8'"
